                  ...
                  <div className="row justify-content-start">
                    <div className="col-10 col-lg-8">
                      ...
                      <p className="fs-5 fw-medium text-white mb-4 pb-3">
                        ...
                        elit. Vitae, vero eum! Eveniet explicabo nulla
                        consectetur optio cum illo, quaerat odio corporis dolore
                        beatae impedit maiores, dolores tempore, quasi ab quo!
                      </p>
                      <Link
              ...
              >
                <div className="fact-item text-center bg-light h-100 p-5 pt-0">
                  ...
                  <p className="mb-0">
                    ...
                    corrupti sapiente similique harum, atque quae fuga neque
                    quos reiciendis nesciunt.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="fact-item text-center bg-light h-100 p-5 pt-0">
                  ...
                  <p className="mb-0">
                    ...
                    Neque placeat modi eligendi aspernatur corrupti consequuntur
